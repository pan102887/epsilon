...
async def test_upsert_then_get_roundtrip(redis_client) -> None:
...
async def test_get_missing_returns_none(redis_client) -> None:
...
async def test_list_recent_uses_zset_descending_order(redis_client) -> None:
...
async def test_list_recent_removes_stale_zset_member(redis_client) -> None:
...
async def test_delete_removes_metadata_and_zset_member(redis_client) -> None:
...
async def test_list_recent_non_positive_limit_returns_empty(redis_client) -> None:
...
async def test_corrupted_metadata_returns_none(redis_client) -> None:
